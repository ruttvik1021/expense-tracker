...
Expense Tracker is a web app that helps you record, categorize and visualize your daily expenses. The app includes account management (register/login/verify email), categories, payment sources, transactions, charts and basic analytics.
