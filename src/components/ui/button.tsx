...
const buttonVariants = cva(
  "inline-flex items-center justify-center relative overflow-hidden whitespace-nowrap rounded-md text-base font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-foreground rounded-md",
  {
    variants: {
      variant: {
        default:
